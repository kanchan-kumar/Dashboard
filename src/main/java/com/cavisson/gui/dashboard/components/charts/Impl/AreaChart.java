...
public class AreaChart extends AbstractVaadinChartExample
{
    ...
    public Component getChart()
    {
        ...
        conf.setTitle(new Title("Area Chart"));
        //conf.setSubTitle(new SubTitle("Source: thebulletin.metapress.com"));
        ...
        tooltip.setFormatter("this.series.name +' produced '+ Highcharts.numberFormat(this.y, 0) +'warheads in '+ this.x");
        conf.setTooltip(tooltip);

        final Number usaNumbers[] = new Number[]
        {
            null, null, null, null,
        ...
        final Number ussrNumbers[] = new Number[]
        {
            null, null, null, null,
