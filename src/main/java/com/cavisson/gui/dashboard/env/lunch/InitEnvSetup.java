...
import com.cavisson.gui.dashboard.components.charts.Impl.PieChart;
...
public class InitEnvSetup extends UI
{
    ...
    protected void init(VaadinRequest request)
    {
        ...
        try
        {
            horizontalSplitPanel.setFirstComponent(getLeftPanelTree());
        }
        catch (IOException ex)
        {
            Logger.getLogger(InitEnvSetup.class.getName()).log(Level.SEVERE, null, ex);
        }
