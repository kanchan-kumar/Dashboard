...
import com.cavisson.gui.dashboard.components.controls.Trees;
import com.cavisson.gui.dashboard.components.controls.ValoThemeSessionInitListener;
import com.cavisson.gui.dashboard.components.windows.RightPane;
import com.cavisson.gui.dashboard.components.windows.TopPanel;
...
public class InitEnvSetup extends UI
{
  ...
  int height = 0;
  int width = 1;
  VerticalSplitPanel innerVerticalSplitPanel = null;
  ...
  protected void init(VaadinRequest request)
  {
    ...
    if (request instanceof VaadinServletRequest)
    {
      ...
      this.getSession().setAttribute("screenWidth", Page.getCurrent().getBrowserWindowWidth());
      this.getSession().setAttribute("screenHeight", Page.getCurrent().getBrowserWindowHeight());
      try
      {
        Page.getCurrent().addBrowserWindowResizeListener(new Page.BrowserWindowResizeListener()
        {
          ...
          public void browserWindowResized(Page.BrowserWindowResizeEvent event)
          {
            ...
            System.out.println("****************UHJHHHHHHHHHHHHHH(***************** height = " + height + ", widht = " + width);
            System.out.println("Width = " + Page.getCurrent().getBrowserWindowWidth());
            System.out.println("Height = " + Page.getCurrent().getBrowserWindowHeight());
            if (rightPane != null)
            {
              innerVerticalSplitPanel.setSecondComponent(rightPane.getRightPanelLayout(Page.getCurrent().getBrowserWindowWidth(), Page.getCurrent().getBrowserWindowHeight()));
            }
          }
        });
      }
    ...
    verticalLayout.addComponent(upperPanel);
    TopPanel topPanel = new TopPanel();
    verticalLayout.addComponent(topPanel);

    innerVerticalSplitPanel = new VerticalSplitPanel();
    rightPane = new RightPane(Page.getCurrent().getBrowserWindowWidth(), Page.getCurrent().getBrowserWindowHeight(), graphDataProvider);

    horizontalLayout.setStyleName("large");
        //horizontalSplitPanel.setStyleName(Reindeer.);

    //VerticalLayout verticalLayout = new VerticalLayout(); 
    innerVerticalSplitPanel.setFirstComponent(verticalLayout);
    innerVerticalSplitPanel.setSecondComponent(rightPane.getRightPanelLayout(width, height));
    ...
    outerVerticalSplitPanel.setSplitPosition(78);
  ...
  private Trees getLeftPanelTree() throws IOException
  {
    return new Trees();
  }
  ...
  private VerticalLayout createLowerPanelTable()
  {
    try
    {
      ...
      {
        new Integer(100500), "Graph 1", new Date(), new Double(0.0), new Double(0.0), new Double(0.0), new Double(0.0), new Double(0.0)
      }, new Integer(1));
      table.addItem(new Object[]
      {
        new Integer(100501), "Graph 2", new Date(), new Double(0.0), new Double(0.0), new Double(0.0), new Double(0.0), new Double(0.0)
      }, new Integer(2));
      table.addItem(new Object[]
      {
        new Integer(100502), "Graph 3", new Date(), new Double(0.0), new Double(0.0), new Double(0.0), new Double(0.0), new Double(0.0)
      }, new Integer(3));
      table.addItem(new Object[]
      {
        new Integer(100503), "Graph 4", new Date(), new Double(0.0), new Double(0.0), new Double(0.0), new Double(0.0), new Double(0.0)
      }, new Integer(4));
      table.addItem(new Object[]
      {
        new Integer(100504), "Graph 5", new Date(), new Double(0.0), new Double(0.0), new Double(0.0), new Double(0.0), new Double(0.0)
      }, new Integer(5));
      table.addItem(new Object[]
      {
        new Integer(100505), "Graph 6", new Date(), new Double(0.0), new Double(0.0), new Double(0.0), new Double(0.0), new Double(0.0)
      }, new Integer(6));
