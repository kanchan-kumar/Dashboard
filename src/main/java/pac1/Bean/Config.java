...
public class Config
{
  ...
  static String className = "Config";
  ...
  // 2- "rtg" for server
  // 3- "" for applet(client)
  public static String logFilePrefix = "gui";
  ...
  /** Wrapper method of getIntValue method **/  
 ...
 * **/
  ...
  public static String getIntValue(String key, String DefaultValue)
  {
    String value;
   ...
   public static String getValueWithPath(String key)
  {
    String value;
  ...
  public static String getValueWithHPDPath(String key)
  {
    String value;
